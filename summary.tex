...
\mynotes{
Put another way, as a task of grasping the \keyword{essence} of a given subject with respect to its context clearly, through a comprehensive view of it as both a unified whole and as a composition of relations.

Put another way, as a task of grasping the essence of a given subject with respect to its context clearly,
...
However, I am more naturally inclined toward and enjoy rigorous, logically-oriented work, such as \keyword{backend development} and \keyword{system architecting}.
...
developing a \keyword{distributed system} in my previous work,
and would prefer to pursue this path deeper as much as possible.
\mynotes{
