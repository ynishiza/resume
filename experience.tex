...
\cventry
  ...
  {June 2014 - August 2022} % Date(s)
  {
    \begin{itemize} % Description(s) of tasks/responsibilities
      ...
      \item {
        \tgproject{Exaptive Studio (2014-2018)} A low-code platform, featuring not only components client-side in JavaScript but also server-side in Python 2 (+Python 3 unofficially) and R.
